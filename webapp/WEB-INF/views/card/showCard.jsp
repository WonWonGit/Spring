			...
			<ul class="pagination justify-content-center">
				<c:if test="${pagination.prev}">
					...
					<li class="page-item"><a class="page-link"
						href="${pageContext.request.contextPath}/card/showCard?list_name=<c:out value="${param.list_name}"/>&uid=<c:out value="${sessionScope.userId}"/>&page=<c:out value="${page}"/>&range=<c:out value="${range}"/>">
							Previous</a></li>
				...
				<c:forEach begin="${pagination.startPage}"
					...
					<li
						...
						class="page-link"
						href="${pageContext.request.contextPath}/card/showCard?list_name=<c:out value="${param.list_name}"/>&uid=<c:out value="${sessionScope.userId}"/>&page=<c:out value="${idx}"/>&range=<c:out value="${pagination.range}"/>">
							${idx} </a></li>
				</c:forEach>
				<c:if test="${pagination.next==true}">
					...
					<li class="page-item"><a class="page-link"
						href="${pageContext.request.contextPath}/card/showCard?list_name=<c:out value="${param.list_name}"/>&uid=<c:out value="${sessionScope.usrId}"/>&page=<c:out value="${page}"/>&range=<c:out value="${pagination.range}"/>">
							Next</a></li>
