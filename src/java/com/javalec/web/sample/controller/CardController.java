...
public class CardController {
	...
	public String insertSet(@ModelAttribute("cardVO") CardVO cardVO, Model model,HttpServletResponse response, HttpSession session) throws Exception{
	...
	public String insertCard(@ModelAttribute("cardVO") CardVO cardVO, Model model, HttpServletResponse response, HttpSession session) throws Exception {
		...
		return "redirect:/card/showCard?list_name="+cardVO.list_name+"&uid="+cardVO.uid;
	}
